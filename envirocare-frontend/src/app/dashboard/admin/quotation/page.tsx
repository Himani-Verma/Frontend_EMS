  ...
  useEffect(() => {
    ...
    if (searchQuery) {
      filtered = filtered.filter(quotation => 
        ...
        quotation.owner.toLowerCase().includes(searchQuery.toLowerCase())
      )
    }
    ...
    // Owner filter
    if (ownerFilter !== 'All') {
      filtered = filtered.filter(quotation => quotation.owner === ownerFilter)
    }

    setFilteredQuotations(filtered)
  }, [quotations, searchQuery, statusFilter, ownerFilter])
        ...
        <div className="flex-1 ml-0 md:ml-0">
          <div className="p-6 space-y-6">
            ...
            <div className="mb-8">
              ...
              <p className="mt-2 text-gray-600">Manage and track all quotations</p>
            </div>
            ...
            <div className="bg-white rounded-2xl border p-6 shadow-sm">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                {/* Owner Filter */}
                <div>
                  <label className="block text-sm font-medium mb-2 text-gray-700">Owner</label>
                  <select
                    value={ownerFilter}
                      ...
                      <tr key={quotation.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                          <div className="flex space-x-2">
                            ...
                            <button 
                              onClick={() => console.log('Send quotation:', quotation.id)}
                              className="text-purple-600 hover:text-purple-900"
                            >
                              Send
                            </button>
                            <button 
                              onClick={() => console.log('Convert to invoice:', quotation.id)}
