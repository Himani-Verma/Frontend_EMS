...
export default function ExecutiveDashboard() {
  ...
  useEffect(() => {
    ...
    console.log('🔍 ExecutiveDashboard: Loading user data...', { userStr: userStr ? 'Found' : 'Not found' });
    
    if (userStr) {
      try {
        const userData = JSON.parse(userStr);
        console.log('👤 ExecutiveDashboard: User data loaded:', { name: userData.name, role: userData.role });
        setUser(userData);
      ...
      console.log('❌ ExecutiveDashboard: No user data found, redirecting to login');
      router.push('/login');
      return;
    }
